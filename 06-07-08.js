...
let nombres = this.amigos.map(function(elementos){
...
return nombres
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      let edades = this.amigos.map (function(elementos){
        ...
        return elementos.edad
          ...
          var reducir = edades.reduce((acumulador,numero)=>{
          ...
          var porcentaje = edades.length
        
          return reducir / porcentaje
    }
  };
